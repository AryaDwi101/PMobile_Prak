...
object BookDataHelper {
    fun getCoverUrl(index: Int): String {
        return when (index) {
            ...
            5 -> "https://upload.wikimedia.org/wikipedia/en/b/b5/Harry_Potter_and_the_Half-Blood_Prince_cover.png"
            6 -> "https://upload.wikimedia.org/wikipedia/en/a/a9/Harry_Potter_and_the_Deathly_Hallows.jpg"
            7 -> "https://upload.wikimedia.org/wikipedia/en/8/87/Cursed_Child_new_poster.jpg"
